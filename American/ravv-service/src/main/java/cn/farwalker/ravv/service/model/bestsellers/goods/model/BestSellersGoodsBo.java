package cn.farwalker.ravv.service.model.bestsellers.goods.model;
 ...
 */
@TableName(BestSellersGoodsBo.TABLE_NAME)
@DDLTable(name=BestSellersGoodsBo.TABLE_NAME,comment="销售最好商品")
public class BestSellersGoodsBo extends Model<BestSellersGoodsBo> implements BaseBo{
     /** 字段名枚举 */
    ...
    /** 数据表名:best_sellers_goods*/
    public static final String TABLE_NAME = "best_sellers_goods";
    private static final long serialVersionUID = 1908720115L;
