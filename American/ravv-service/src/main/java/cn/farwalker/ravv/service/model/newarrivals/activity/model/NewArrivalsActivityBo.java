package cn.farwalker.ravv.service.model.newarrivals.activity.model;
 ...
 */
@TableName(NewArrivalsActivityBo.TABLE_NAME)
@DDLTable(name=NewArrivalsActivityBo.TABLE_NAME,comment="新品到达活动")
public class NewArrivalsActivityBo extends Model<NewArrivalsActivityBo> implements BaseBo{
     /** 字段名枚举 */
    ...
    /** 数据表名:new_arrivals_activity*/
    public static final String TABLE_NAME = "new_arrivals_activity";
    private static final long serialVersionUID = -2067382122L;
