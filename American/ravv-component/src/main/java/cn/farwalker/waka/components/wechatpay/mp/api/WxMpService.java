...
public interface WxMpService {
	...
	/** 沙箱环境下获取prepayId */
	WxMpPrepayIdResult getPrepayIdWithSandBox(Map<String, String> parameters);

	String getSignBySandBox(Map<String, String> parameters);
	...
	Map<String, String> getJSSDKPayInfoWithSandBox(Map<String, String> parameters);

	/**
	 * 该接口调用“查询订单”接口，并拼装JSSDK发起支付请求需要的参数
	 * 详见https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=9_2&index=4
	 * @param transactionId
	 * @param outTradeNo
	 * @return
	 */
	Map<String, String> getJSSDKQueryPay(String transactionId, String outTradeNo);
