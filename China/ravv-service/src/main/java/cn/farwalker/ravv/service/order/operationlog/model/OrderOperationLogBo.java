package cn.farwalker.ravv.service.order.operationlog.model;
 ...
 */
@TableName(OrderOperationLogBo.TABLE_NAME)
@DDLTable(name=OrderOperationLogBo.TABLE_NAME,comment="订单操作日志")
public class OrderOperationLogBo extends Model<OrderOperationLogBo> implements BaseBo{
     /** 字段名枚举 */
    ...
    /** 数据表名:order_operation_log*/
    public static final String TABLE_NAME = "order_operation_log";
    private static final long serialVersionUID = -218716072L;
