package cn.farwalker.waka.generator.engine.config;
 ...
 *
 * @author Jason Chen
 * @date 2017-11-08 20:21
 */
public class ContextConfig {

    private String templatePrefixPath = "wakaTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\waka";//模板输出的项目目录
    private String adminPath = "D:\\ideaSpace\\waka";
    ...
    private String proPackage = "cn.farwalker.waka.admin";
    private String coreBasePackage = "cn.farwalker.waka.core";
    private String modelPackageName = "cn.farwalker.waka.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "cn.farwalker.waka.admin.common.persistence.dao";  //model的dao
