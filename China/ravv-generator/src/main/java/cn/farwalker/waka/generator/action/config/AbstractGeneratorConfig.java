...
import cn.farwalker.waka.generator.engine.SimpleTemplateEngine;
import cn.farwalker.waka.generator.engine.base.WakaTemplateEngine;
import cn.farwalker.waka.generator.engine.config.ContextConfig;
import cn.farwalker.waka.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doWakaGeneration() {
        WakaTemplateEngine wakaTemplateEngine = new SimpleTemplateEngine();
        wakaTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        wakaTemplateEngine.setSqlConfig(sqlConfig);
        wakaTemplateEngine.setTableInfo(tableInfo);
        wakaTemplateEngine.start();
    }
}
